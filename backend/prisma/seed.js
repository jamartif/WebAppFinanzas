...
async function main() {
  ...
  const categories = [
    ...
    { name: 'Crowdfunding Inmobiliario', type: 'CROWDFUNDING', description: 'Plataforma de crowdfunding inmobiliario' },
    { name: 'Crowdlending', type: 'CROWDFUNDING', description: 'Plataforma de crowdlending' },
  ];
